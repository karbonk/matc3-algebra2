...
\item $\frac{1}{2}\cdot\frac{1}{x+1}-\frac{x}{5-2x} = \frac{1}{2}-\frac{1}{4}\cdot\frac{2x-15}{2x-5}$; %pag190
...
\item $15x^{2}+6ax-5bx-2ab=0$. %pag383
\end{enumeratea}
\end{multicols}
\end{esercizio}

\begin{esercizio}[\Ast]
 \label{ese:3.63} %nuovo pag383
Risolvi ed eventualmente discuti le seguenti equazioni letterali.
\begin{multicols}{2}
\begin{enumeratea}
...
\begin{center}
\input{lbr/chap03/fig002_seg.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap03/fig007_rett.pgf}
\end{center}
\end{esercizio}
...
\begin{center}
 \input{./lbr/chap03/fig009_quad.pgf}
\end{center}
\end{esercizio}
...
\begin{center}
 \input{./lbr/chap03/fig008_rett.pgf}
\end{center}
\end{esercizio}
...
\begin{center}
 \input{./lbr/chap03/fig011_seg.pgf}
\end{center}
\emph{Svolgimento}:
...
\begin{center}
 \input{./lbr/chap03/fig012_trap.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap03/fig013_cono.pgf}
\end{center}
...
\paragraph{3.2.} c)~$x_{1\text{,}2} = \frac{\pm \sqrt{15}}{5}$,\quad e)~$x_{1\text{,}2} = \pm\frac{5}{3}$,\quad f)~$x_{1\text{,}2} = 0$,\quad i)~$x_{1\text{,}2} = \pm 7$,\quad k)~$x_{1\text{,}2} = \pm\frac{1}{3}$,\quad l)~$x_{1\text{,}2} = \pm 2$.
...
%\paragraph{3.6.} g)~$x_{1} = 0 \vee x_{2} = 2$,\quad i)~$x_{1} = 0 \vee x_{2} = \frac{1}{2}$,\quad k)~$x_{1} = 0 \vee x_{2} =  \frac{5}{6}$.
...
\paragraph{3.7.} a)~$x_{1} = 0 \vee x_{2} = \frac{4}{9}$,\quad c)~$x_{1} = 0 \vee x_{2} = - 2$,\quad d)~$x_{1} = 0 \vee x_{2} = -2\sqrt{2}$,\quad e)~$x_{1} = 0 \vee x_{2} = 7$,\quad g)~$x_{1} = 0 \vee x_{2} = - \frac{6}{11}$,\quad h)~$x_{1} = 0 \vee x_{2} = 6$,\quad i)~$x_{1} = 0 \vee x_{2} = 1$,\quad j)~$x_{1} = 0 \vee x_{2} = 4$.
...
%\paragraph{3.17.} a)~$x_{1\text{,}2} = \frac{3 \pm \sqrt{19}}{2}$,\quad b)~$x_{1} = 1 \vee x_{2} = \frac{1}{2}$,\quad c)~$x_{1} = 1 \vee x_{2} =-\frac{3}{4}$,\quad d)~$x_{1} =-1 \vee x_{2} = \frac{2}{3}$.
...
\paragraph{3.13.} a)~$x_{1} =5\vee x_{2} = 10$,\quad b)~$x_{1} =\frac{5}{9}\vee x_{2} =\frac{16}{3}$,\quad c)~$x_{1} = 0 \vee x_{2} =\frac{1}{5}$,\quad d)~$x_{1} =-\frac{7}{6} \vee x_{2} =0$,\quad e)~$x_{1} =0 \vee x_{2} =\frac{1}{2}$. %nuovo
...
%\paragraph{3.24.} a)~$x_{1\text{,}2} = \frac{- 2 \pm \sqrt{3}}{3}$,\quad b)~$x_{1\text{,}2} = \frac{2}{3}$,\quad c)~$x_{1\text{,}2} = 4 \pm 2 \sqrt{3}$,\quad d)~$\emptyset$.
...
\paragraph{3.22.} a)~$x_{1} = x_{2} = 0$,\quad b)~$\emptyset$,\quad c)~$x_{1\text{,}2}= 3-\sqrt{2}$,\quad d)~$x_{1} = 0 \vee x_{2} = \frac{14}{9}$.
...
\paragraph{3.29.} a)~$x_{1\text{,}2} = -2\pm \sqrt{6}$,\quad b)~$x_{1\text{,}2} =\frac{5 \pm 3\sqrt{5}}{6}$,\quad c)~$x_{1} =11 \vee x_{2} =\frac{17}{3}$,\quad d)~$x_{1\text{,}2} =0$.
...
\paragraph{3.36.} a)~$x_{1} =-3 \vee x_{2} = 1$,\quad b)~$x_{1\text{,}2}= 1$,\quad c)~$\emptyset$,\quad d)~$x_{1} = 0 \vee x_{2} = 6$.
...
\paragraph{3.44.} a)~$x_{1\text{,}2} = \frac{- 7 \pm \sqrt{97}}{8}$,\quad b)~$x_{1} =-1 \vee x_{2} = 1$,\quad c)~$x_{1} =-\frac{1}{3} \vee x_{2} = \frac{1}{3}$,\protect \\ \quad d)~$x_{1} = \sqrt{6}-\sqrt{2} \vee x_{2} = \sqrt{2}-\sqrt{6}$.
...
\paragraph{3.51.} a)~$x_{1} =3 \vee x_{2} =\frac{2}{3}$,\quad b)~$x_{1} =4;\,x_{2} =1\text{ non accettabile}$,\quad c)~$x_{1} =5 \vee x_{2} =\frac{11}{5}$,\protect\\
...
\paragraph{3.62.} a)~$x_{1\text{,}2} =-3t$,\quad b)~$x_{1} =-1\vee x_{2} = k$,\quad c)~$x_{1\text{,}2} = \sqrt{m} \pm 1$,\quad d)~$x_{1} =-\frac{2}{5}a \vee x_{2} =\frac{b}{3}$.
...
\paragraph{3.95.} a)~$\frac{x-5}{x-3}$,\quad b)~$\frac{x}{x-1}$,\quad c)~$\frac{x-4}{2-x}$,\quad d)~$\frac{x-2}{x+3}$,\quad e)~$\frac{3x-1}{5x+1}$,\quad f)~$\frac{3x+2}{2x-3}$,\quad g)~$\frac{x+1}{x-7}$,\quad h)~$\frac{2x+3}{3x+2}$,\quad i)~$\frac{2x+1}{2x+3}$. %pag393
