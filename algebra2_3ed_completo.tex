...
%%% Prima Parte
%%%
\include{chap/part_01} 
\include{chap/01_reali2} 
\include{chap/02_radicali}
%%%
%%% Seconda Parte
%%%
\include{chap/part_02} 
\include{chap/03_equa2gr}
\include{chap/04_diseq2gr}
%%%
%%% Terza Parte
%%%
\include{chap/part_03} 
\include{chap/05_eqmag2}
\include{chap/06_sistemi}
\include{chap/07_eqmod}
\include{chap/08_eqirrz}
%%%
%%% Quarta Parte
%%%
\include{chap/part_04}
\include{chap/09_probabil}
%%
...
%%% Quinta Parte
%%%
\include{chap/part_05}
\include{chap/08a_successioni}
\end{document}
